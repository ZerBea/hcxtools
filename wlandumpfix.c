...
#define TIME_INTERVAL_2S 0
#define TIME_INTERVAL_2NS 100000000
...
set_timer(timer2, TIME_INTERVAL_2S, TIME_INTERVAL_2NS);
return FALSE;
}
/*===========================================================================*/
...
if(signo == TT_SIGUSR2)
	{
	zeiger = proberequestliste +beaconcount;
...
setbuf(stdout, NULL);
srand(time(NULL));
while ((auswahl = getopt(argc, argv, "i:o:c:hv")) != -1)
	{
	switch (auswahl)
		{
		case 'i':
