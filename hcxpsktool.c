...
{
    "ace", "act", "add", "ado", "age", "ago", "aid", "ail", "aim", "all", "any", "ape",
    "apt", "art",
...
static const char *word5[] =
{
    ...
    "cable", "cakes", "cards", "cargo", "cause", "cheap", "chips", "choke", "climb", "clove", "comic", "count",
    "cover", "crash", "crude", "cruel", "cubic", "curry",
    ...
    "fancy", "fibre", "fifty", "filed", "files", "final", "floor", "flour", "focus", "foggy", "front", "fruit",
    ...
    "novel", "nurse",
    "optic",
    "panda", "pause", "pedal", "piece", "piety", "pious", "place", "plant", "pound", "prime", "prize", "probe",
    "prose", "prune", "puppy", "pylon",
    "quiet",
    ...
    "tally", "tempt", "these", "thick", "thief", "tidal", "tiger", "today", "track", "trick", "trust", "tuned",
    "twigs", "twist",
    "upend", "upper", "upset",
