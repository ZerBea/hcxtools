...
static const char *word1[] =
{
"able", "about", "above", "actor", "again", "also", "apple",
...
"game", "ghost", "girl", "giude", "give", "green", "group", "guest",
