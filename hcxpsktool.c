...
"neat", "nest", "new", "nifty", "nine", "noble", "noisy", "normal",
"north", "oasis", "object", "ocean", "odd", "olive", "open", "orange",
"outlet", "oxygen", "palm", "parade", "past", "pastel", "patron", "perfect",
...
"west", "wide", "windy", "wine", "winter", "witty", "wonderful", "wooden",
...
"field", "fig", "finch", "finish", "fire", "fish", "flo", "flower",
"fluent", "flute", "form", "formal", "fox", "friend", "gadfly", "gallon",
"garden", "gate", "genius", "giant", "global", "goal", "grain", "green",
...
"shoe", "shrub", "singer", "skates", "sky", "sled", "snail", "snake",
"snall", "soccer", "socks", "sofa", "space", "spark", "sparrow", "speech",
"spider", "spoon", "squash", "squirrel", "stable", "star", "state", "statue",
"storm", "stove", "straw", "street", "studio", "study", "summit", "sun",
"table", "tablet", "tea", "teapot", "teapoty", "teen", "tent", "thanks",
...
"voyage", "wagon", "walnut", "watch", "water", "wealth", "week", "west",
...
{
"above", "after", "again", "also", "apple",
"back", "bean", "best", "bike", "blue", "body", "book",
"cake", "calm", "card", "cash", "cold", "cool",
"dark", "dash", "dear", "done", "down",
"early", "earth", "easy", "edit", "envy", "exist",
"face", "fall", "feed", "five",
"game", "ghost", "girl", "give", "good",
...
"each", "earth", "easy", "edit", "exit",
"fact", "fall", "fast", "feel", "five",
...
"occur", "over",
"park", "part", "past", "path", "photo",
"queen", "quest", "quick",
"reach", "rice", "ride", "road", "rope", "rule",
"safe", "salt", "sick", "sunny",
"team", "tell", "think",
"unit",
"water", "week", "west", "what", "where", "wind", "word"
};
