...
static const char *firstword[] = { "absurd", "agency", "ago", "album", "ancient", "anchor", "antique", "aquatic",
	...
	"east", "elated", "elegant", "emigrant", "energy", "engine", "excite", "excited", "exotic",
	"famous", "fancy", "fearless", "festive", "few", "finish", "fluent", "fluffy", "formal", "free", "fresh", "friendly", "funny", "fuzzy",
	"gallon", "gentle", "gifted", "gigantic", "global", "good", "graceful", "grand", "great", "green",
	"happy", "harbor", "heavy", "height", "helpful", "honor", "hot", "hotel", "hungry", "husky",
	...
	"slower", "small", "smart", "smiley", "smiling", "smooth", "snug", "soft", "sour", "spirit", "stealth", "strange", "strong",
...
static const char *secondword[] = { "absent", "acre", "agency", "airplane", "album", "ape", "apple", "automobile",
	...
	"planet", "pledge", "plum", "pocket", "poetry", "pond", "poodle", "potato", "prairie", "prose",
	...
	"snail", "snake", "soccer", "socks", "space", "spark", "sparrow", "spider", "squash", "squirrel", "stable", "star", "state", "statue", "stream",
	"street", "studio", "sun",
