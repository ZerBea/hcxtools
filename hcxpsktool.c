...
"famous", "fancy", "farmer", "fast", "festive", "field", "fight", "finch",
"finish", "fire", "fish", "fit", "flower", "fluent", "fluffy", "flute",
"formal", "free", "fresh", "friend", "fruit", "funny", "fuzzy",
...
static const char *word4[] =
{
    ...
    "pens", "pier", "pine", "pins", "pint", "pity", "plan", "poem", "pond", "pool", "poor", "post",
    "pure",
