...
"winter", "witty", "wonderful", "wooden", "writer", "yacht", "yard", "year",
...
"make", "mail", "meet", "more", "most", "mouth", "much",
"name", "near", "nose", "note",
...
"unit", "upper",
"water", "wind", "what", "word"
};

static const char *word2[] =
{
"about", "above", "again", "also", "apple",
"back", "bean", "best", "bike", "bird", "blue", "body", "book",
"calm", "child", "cool",
"daily", "dark", "dash", "dear", "door",
...
"keep",
"land", "light", "lock",
"mail", "make", "main", "major", "meet", "more", "most", "mouth", "much",
"name", "north", "nose", "note",
"occur", "over",
"park", "part", "path", "photo",
"quest", "quick",
"reach", "rice", "ride", "road", "rope",
...
"daily", "dark", "dash", "dear", "done", "door", "down", "duty",
