...
static const char *adjectiv[] = { "absurd", "agency", "ago", "album", "ancient", "anchor", "antique", "aquatic",
	...
	"calm", "camera", "carrot", "cash", "charming", "cheerful", "chilly", "chip", "chorus", "chummy", "classy", "clean",
	"clear", "clever", "cloudy", "cold", "cool", "crispy", "curly",
	"daily", "deep", "delightful", "dizzy", "down", "dynamic",
	"east", "elated", "elegant", "energy", "engine", "excite", "excited", "exotic",
	"famous", "fancy", "fearless", "festive", "finish", "fluent", "fluffy", "formal", "free", "fresh", "friendly", "funny", "fuzzy",
	"gallon", "gentle", "gifted", "gigantic", "global", "good", "graceful", "grand", "great", "green",
	"happy", "harbor", "heavy", "height", "helpful", "honor", "hot", "hungry", "husky",
	...
	"magical", "major", "manic", "mellow", "melodic", "mighty", "mirror", "misty", "modern", "month", 
	"narrow", "nest", "new", "nice", "nifty", "noisy", "normal",
	"oasis", "object", "occur", "ocean", "odd", "old", "orange", "ordinary",
	"painless", "palm", "parade", "pass", "pastel", "peaceful", "perfect", "phobic", "phone", "pink", "plain", "pledge", "pocket", "polite",
	"poor", "praise", "precious", "pretty", "purple",
	...
	"tablet", "teal", "terrific", "thirsty", "thoughtful", "timber", "tiny", "top",
...
static const char *substantiv[] = { "agency", "airplane", "album", "ape", "apple", "automobile",
	...
	"farmer", "field", "finch", "finish", "fire", "fish", "flamingo", "flower", "fluent", "flute", "forest", "formal", "free", "friend",
	...
	"planet", "plum", "pocket", "poetry", "pond", "poodle", "potato", "prairie", "prose",
	"quail", "quaint", "quick", "quote",
	"rabbit", "raccoon", "raft", "raid", "rain", "raven", "reason", "review", "reward", "river", "road", "rock", "robert", "rosebud",
	"ruby", "runner",
	"sea", "seed", "shark", "sheep", "shelf", "ship", "shoe", "shore", "shrub", "side", "silver", "sitter", "skates", "skin", "sky", "sled",
