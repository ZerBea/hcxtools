...
"clean", "clever", "clock", "cloudy", "country", "clumsy", "coat", "coconut",
"coffee", "comet", "content", "cool", "cow", "cream", "crispy", "crown",
"curly", "curtain",
...
"rocky", "role", "rose", "rosebud", "round", "royal", "runner", "rustic",
...
static const char *word3[] =
{
    ...
    "cad", "cam", "can", "cop", "cup", "cut",
    "dam", "did", "die", "dig", "dim", "dip", "dog", "dry", "due", "dug",
    ...
    "rat", "raw", "red", "rid", "rig", "rob", "rot", "run",
    "sad", "set", "sew", "shy", "sim", "sin", "sip", "sir", "sit", "six", "sow", "spy",
    "tag", "tap", "tax", "ten", "tic", "tip", "ton", "top", "tow", "toy", "try", "two",
    "use",
    "vex", "vow",
    "wet", "win", "won"
};
...
static const char *word4[] =
{
    ...
    "jets", "joke", "judo",
    "keen", "kiss",
    "lack", "land", "late", "lazy", "less", "link", "live", "loaf", "loan", "logo", "lord", "look",
    "loss", "loud",
    "menu", "mere", "mill", "mine", "mist", "most", "move", "much",
    "name", "neat", "need", "nest", "noon", "nude",
    "oars", "oust",
    "pads", "page", "paid", "pain", "pale", "pane", "pars", "part", "past", "pear", "pegs", "pier",
    "paid", "pine", "pins", "pint", "pity", "plan", "poem", "pond", "pool", "poor", "post", "pure",
    "rare", "real", "rest", "rich", "riot", "ripe", "roam", "room", "root", "rude",
    "safe", "sail", "sale", "same", "sand", "save", "scan", "sdlb", "seal", "seat", "seem", "send",
    "shin", "shop", "sick", "side", "sift", "sign", "sing", "skip", "slim", "slip", "slum", "soap",
    "solo", "sore", "sour", "spit", "stew", "sure",
...
static const char *word5[] =
{
    ...
    "bland", "blank", "boast", "boost", "bored", "bread", "broke",
    "cable", "cakes", "cards", "cargo", "cause", "chair", "cheap", "chips", "choke", "climb", "clove", "coact",
    "comic", "count", "cover", "crane", "crash", "crude", "cruel", "cubic", "curry",
    ...
    "fancy", "fence", "fibre", "fifty", "filed", "files", "final", "floor", "flour", "flute", "focus", "foggy",
    "front", "fruit",
    ...
    "novel", "nurse",
    "optic",
    "pages", "panda", "pause", "pedal", "piece", "piety", "pious", "pivot", "place", "plant", "pound", "prime",
    "prize", "probe", "prose", "prune", "puppy", "pylon",
    "quiet",
    ...
    "squad", "stack", "stand", "stars", "start", "steam", "stick", "stoop", "storm", "sunny", "sweat", "swift",
    "swing", "sword",
    "tally", "tempt", "these", "thick", "thief", "tidal", "tiger", "title", "today", "track", "train", "trick",
    "trust", "tuned", "twigs", "twist",
    "upend", "upper", "upset",
