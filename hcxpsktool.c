...
"front", "full", "funny", "furry", "future", "fuzzy", "gallon", "genius",
"gentle", "giddy", "gifted", "global", "gold", "goofy", "grain", "grand",
"grateful", "great", "green", "grumpy", "guitar", "happy", "harbor", "hearty",
"heavy", "height", "helpful", "high", "hockey", "honest", "honor", "hotel",
"hour", "hungry", "husky", "icy", "idea", "imaginary", "immune", "input",
...
"market", "master", "medium", "mellow", "melodic", "middle", "mighty", "minute",
"mirror", "misty", "mobile", "modern", "month", "most", "much", "museum",
"narrow", "nature", "nearby", "neat", "nest", "new", "nifty", "nine",
"noble", "noisy", "normal", "north", "oasis", "object", "ocean", "odd",
"olive", "open", "orange", "outlet", "oxygen", "palm", "parade", "past",
"pastel", "patron", "perfect", "phobic", "phone", "pink", "plain", "plane",
"pledge", "plenty", "pocket", "polite", "pony", "pool", "praise", "precious",
"prior", "prize", "proper", "prose", "proud", "purple", "quaint", "quick",
"quiet", "quote", "rain", "rainy", "rapid", "rare", "ready", "reason",
"red", "remedy", "review", "reward", "rich", "rocket", "rocky", "rough",
...
"tight", "timber", "tiny", "top", "town", "train", "turtle", "uneven",
...
"windy", "wine", "winter", "witty", "wonderful", "wooden", "worth", "writer",
"yacht", "yard", "year", "yellow", "young", "zany", "zeal", "zebra",
"zone"
};
...
"drama", "drawer", "duty", "eagle", "ear", "earth", "editor", "effort",
"energy", "engine", "epic", "errand", "error", "estate", "event", "extent",
"famous", "farmer", "field", "fig", "finch", "finish", "fire", "fish",
"flower", "fluent", "flute", "form", "formal", "fox", "friend", "gadfly",
"gallon", "garden", "gate", "genius", "giant", "girl", "global", "goal",
"grain", "green", "guitar", "guppy", "hair", "hall", "hand", "harbor",
"hat", "height", "hill", "hippo", "hockey", "home", "honor", "horse",
"hotel", "house", "idea", "idol", "immune", "income", "ink", "input",
"invent", "iris", "island", "jacket", "jade", "jazz", "jeans", "jet",
"jewel", "judge", "jungle", "kayak", "kettle", "key", "kite", "knight",
"ladder", "lake", "law", "lawn", "leader", "lemon", "length", "light",
"lion", "lotus", "loyal", "major", "mango", "map", "marble", "market",
"math", "memory", "menu", "mesa", "method", "mint", "mirror", "mobile",
"moment", "month", "moon", "mud", "museum", "music", "nation", "nature",
"nest", "noble", "north", "oasis", "object", "oboe", "ocean", "octopus",
...
"safety", "salute", "scout", "sea", "sector", "seed", "series", "shark",
"sheep", "shelf", "ship", "shoe", "shrub", "side", "singer", "skates",
"sky", "sled", "snail", "snake", "snall", "soccer", "socks", "sofa",
"song", "space", "spark", "sparrow", "speech", "spider", "spoon", "squash",
"squirrel", "stable", "star", "state", "statue", "storm", "stove", "straw",
"street", "studio", "study", "summit", "sun", "table", "tablet", "tea",
"teapot", "teen", "tent", "thanks", "theory", "tiger", "timber", "tomato",
...
"water", "way", "wealth", "week", "west", "whale", "wind", "window",
