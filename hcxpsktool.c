...
{
    "bake", "bald", "bark", "base", "bath", "boil", "bore",
    "camp", "card", "cent", "clue", "coat", "cute",
    "damp", "desk", "drop",
    "each", "edit", "even",
    "face", "fair", "fine", "flag", "foot", "four", "full",
    "gift", "gown",
    "half", "hard", "hire",
    "jets",
    "keen",
    "lack", "land", "late", "lazy", "less", "link", "live", "logo",
    "move", "much",
    "past", "pear", "pier", "pint", "pity", "plan", "poem", "post",
    "rare", "rich", "riot", "roam", "room", "root",
    "safe", "sale", "save", "scan", "side", "sift", "slim",
    "team", "tide", "trim", "trod",
    "used",
    "vast",
    "wait", "want", "warn", "wave", "wild", "wing", "wise"
};

static const char *word5[] =
{
    "agent", "agony", "ahead", "alarm", "angle", "ankle",
    "bland", "blank", "boost", "bored",
    "cable", "cheap", "chips", "clove", "comic", "cover", "crash", "cruel", "cubic",
    "diner", "dozen", "dusty",
    "early", "elder", "exact", "excel", "extra",
    "fancy", "focus", "front",
    "giant", "gleam", "grids", "grove", "guest",
    "inked", "ivory",
    "learn", "linen", "lyric",
    "madam", "moist", "motto", "mourn",
    "piece", "pious", "prime", "prize", "puppy",
    "rally", "refer", "remit", "renew", "repel", "rocky", "rusty",
    "scoop", "scoot", "shaft", "sharp", "shine", "silly", "socks", "spade", "spare", "stand", "stars", "start",
    "steam", "swing", "sword",
    "tempt", "thief", "track", "trust", "tuned", "twist",
    "upend",
    "vends",
    "wheel", "whole", "worth", "wrist",
    "yeast",
    "zooms"
};
