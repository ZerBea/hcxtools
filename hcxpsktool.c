...
"comet", "content", "cool", "cow", "cream", "crispy", "crown", "curly",
"curtain",
...
"epic", "errand", "excited", "exotic",
"famous", "fancy", "farmer", "fast", "festive", "field", "finch", "finish",
"fire", "fish", "fit", "flower", "fluent", "fluffy", "flute", "formal",
"free", "fresh", "friend", "fruit", "funny", "fuzzy",
...
"light", "lion", "little", "lively", "lotus", "loud", "loyal", "lucky",
...
"silly", "silver", "skates", "sky", "sled", "sleepy", "slow", "small",
"smart", "smiley", "smiling", "smooth", "snail", "snake", "soccer", "socks",
"space", "spark", "sparrow", "spider", "spirit", "spoon", "square", "squash",
"squirrel", "stable", "star", "state", "statue", "stealth", "still", "stove",
...
"whale", "wide", "wild", "wind", "window", "windy", "witty", "wolf",
"wonderful", "wooden", "world", "writer",
...
{
    "abs", "ace", "act", "add", "ado", "age", "ago", "aid", "ail", "aim", "all", "any",
    "ape", "apt", "art",
    "bad", "bay", "beg", "bet", "bid", "big", "bow", "box", "bud", "bun", "bus", "buy",
    "cam", "can", "cop", "cup", "cut",
    "dam", "die", "dig", "dim", "dip", "dog", "dry", "due",
    "ear", "ego", "elk", "end", "era", "eye",
    "fan", "far", "fat", "fax", "fee", "few", "fit", "fix", "fly", "fog", "fox", "fry",
    "gap", "gel", "gem", "get", "god",
    "hid", "hit", "hop", "hot", "how", "hub",
    "icy", "ink", "inn",
    "jar", "job", "jog",
    "key",
    "lay", "led", "leg", "let", "lid", "lie", "lip", "lit", "lob", "lot", "low",
    "mad", "map", "mid", "mix", "mob", "mop", "mow", "mud", "mug",
    "nag", "nap", "net", "new", "nod", "not", "now",
    "oar", "oat", "odd", "off", "oil", "old", "one", "opt", "our", "out", "owe", "own",
    "pal", "pay", "pea", "pen", "per", "pet", "pie", "pin", "ply", "pop", "pub", "put",
    "rat", "raw", "red", "rid", "rob", "rot", "run",
    "sad", "set", "sew", "shy", "sim", "sin", "sip", "sir", "sit", "six", "sow", "spy",
    "tag", "tap", "tax", "ten", "tic", "tip", "top", "tow", "toy", "try", "two",
    "use",
    "vex", "vow",
    "wet", "win", "won"
};
...
{
    "able", "acre",
    "bait", "bake", "bald", "ball", "bark", "base", "bath", "bead", "bell", "best", "boat", "boil",
    "bold", "bore", "both", "busy",
    "calm", "camp", "cape", "card", "case", "cash", "cent", "chef", "city", "clad", "club", "clue",
    "coat", "cool", "copy", "cute",
    "dame", "damp", "dare", "dash", "date", "days", "deaf", "deal", "desk", "dive", "door", "down",
    "draw", "drop",
    "each", "east", "edit", "epic", "even", "ever", "exit",
    "face", "fair", "fake", "fall", "fast", "fine", "firm", "flag", "flee", "foam", "fold", "foot",
    "four", "full", "fuse",
    "gaps", "gave", "gift", "gown", "gray",
    "half", "hang", "hard", "head", "high", "hint", "hire", "hold", "hook", "huge", "hurt", "hymn",
    "idea", "iron",
    "jets", "joke", "judo",
    "keen", "kiss",
    "lack", "land", "late", "lazy", "less", "link", "live", "loaf", "loan", "logo", "look", "loss",
    "loud",
    "mere", "mill", "mine", "most", "move", "much",
    "name", "neat", "need", "nest", "noon", "nude",
    "oars", "oust",
    "pads", "page", "paid", "pain", "pale", "pane", "pars", "part", "past", "pear", "pegs", "pier",
    "pins", "pint", "pity", "plan", "poem", "pond", "pool", "poor", "post", "pure",
    "rare", "real", "rest", "rich", "riot", "ripe", "roam", "room", "root", "rude",
    "safe", "sail", "sale", "same", "save", "scan", "sdlb", "seal", "seat", "seem", "send", "shin",
    "shop", "sick", "side", "sift", "sign", "sing", "skip", "slim", "slip", "slum", "soap", "solo",
    "sore", "sour", "spit", "stew", "sure",
    "tall", "teak", "team", "tear", "then", "tide", "time", "tone", "tour", "trim", "trod", "true",
    "tune", "turn",
    "udjz", "used",
    "vain", "vast", "vlbs", "vote",
...
static const char *word5[] =
{
    ...
    "ankle", "armed", "arrow",
    "bland", "blank", "boast", "boost", "bored", "bread",
    "cable", "cakes", "cards", "cargo", "cause", "cheap", "chips", "choke", "climb", "clove", "coact", "comic",
    "count", "cover", "crash", "crude", "cruel", "cubic", "curry",
    "dance", "dense", "diner", "dines", "dozen", "draft", "dream", "drink", "drown", "drunk", "dusty",
    "early", "elder", "enter", "equal", "equip", "erode", "evens", "event", "exact", "excel", "extra",
    "fancy", "fibre", "fifty", "filed", "files", "final", "floor", "flour", "flute", "focus", "foggy", "front",
    "fruit",
    "genie", "giant", "glare", "gleam", "grave", "great", "grids", "group", "grove", "guess", "guest",
    "harps", "hawks", "heavy", "house",
    "ideal", "inked", "ivory",
    "judge",
    "knock",
    "laces", "large", "learn", "light", "lilac", "linen", "loose", "lucky", "lunar", "lyric",
    "madam", "major", "malts", "maple", "marry", "merit", "moist", "molar", "motto", "mourn", "mouse", "muddy",
    "novel", "nurse",
    "optic",
    "pages", "panda", "pause", "pedal", "piece", "piety", "pious", "place", "plant", "pound", "prime", "prize",
    "probe", "prose", "prune", "puppy", "pylon",
    "quiet",
    "rally", "refer", "remit", "renew", "repel", "roach", "rocky", "roofs", "rooks", "rough", "royal", "rusty",
    "salad", "scarf", "scoop", "scoot", "score", "scorn", "shaft", "sharp", "sheds", "shine", "shiny", "shirt",
    "shrub", "silly", "sixty", "skate", "socks", "sound", "spade", "spare", "spend", "spent", "squad", "stack",
    "stand", "stars", "start", "steam", "stick", "stoop", "storm", "sunny", "sweat", "swift", "swing", "sword",
    "tally", "tempt", "these", "thick", "thief", "tidal", "tiger", "today", "track", "train", "trick", "trust",
    "tuned", "twigs", "twist",
    "upend", "upper", "upset",
...
for(w3 = 0; w3 < (sizeof(word3) / sizeof(char *)); w3++)
	...
	for(w4 = 0; w4 < (sizeof(word4) / sizeof(char *)); w4++)
		...
		for(w5 = 0; w5 < (sizeof(word5) / sizeof(char *)); w5++)
			...
			fprintf(fhout,"%s\n", pskstring);
			pskstring[0] = toupper(pskstring[0]);
			pskstring[1] = toupper(pskstring[1]);
			pskstring[2] = toupper(pskstring[2]);
			fprintf(fhout,"%s\n", pskstring);
			...
			pskstring[1] = toupper(pskstring[1]);
			pskstring[2] = toupper(pskstring[2]);
			pskstring[3] = toupper(pskstring[3]);
			fprintf(fhout,"%s\n", pskstring);
			...
			pskstring[2] = toupper(pskstring[2]);
			pskstring[3] = toupper(pskstring[3]);
			pskstring[4] = toupper(pskstring[4]);
			fprintf(fhout,"%s\n", pskstring);
