...
static const char *secondword[] =
{
"acre", "actor", "ad", "advice", "agency", "airplane", "album", "anchor",
"apple", "area", "author", "ave", "bakery", "ball", "balloon", "banana",
...
"dinner", "dirt", "dog", "doll", "domain", "duty", "eagle", "ear",
"earth", "effort", "energy", "engine", "epic", "errand", "error", "estate",
"famous", "farmer", "field", "finch", "finish", "fire", "fish", "flower",
"fluent", "flute", "formal", "fox", "friend", "gadfly", "gallon", "garden",
"gate", "genius", "giant", "global", "grain", "guitar", "guppy", "hair",
"hall", "hand", "harbor", "hat", "height", "hill", "hippo", "hockey",
"home", "honor", "horse", "hotel", "house", "idea", "immune", "ink",
...
"lion", "lotus", "loyal", "major", "mango", "marble", "market", "math",
"menu", "mesa", "method", "mint", "mirror", "mobile", "month", "moon",
"mud", "museum", "nation", "nature", "nest", "noble", "north", "oasis",
"object", "oboe", "ocean", "octopus", "onion", "orange", "outlet", "owl",
"owner", "oxygen", "palm", "panda", "pant", "paper", "parade", "park",
"patron", "peach", "pear", "pencil", "people", "phoenix", "phone", "piano",
"pizza", "place", "planet", "pledge", "plum", "pocket", "poem", "poet",
...
"scout", "sea", "seed", "series", "shark", "sheep", "shelf", "ship",
...
"volume", "voyage", "wagon", "walnut", "watch", "wate", "water", "wealth",
"week", "west", "whale", "wind", "window", "windy", "wolf", "world",
"writer", "yacht", "yard", "year", "zeal", "zebra", "zone", "zoo"
};
