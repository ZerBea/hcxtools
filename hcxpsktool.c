...
static const char *adjectiv[] = { "absurd", "ago", "album", "ancient", "antique", "aquatic",
	...
	"east", "elated", "elegant", "energy", "excite", "excited", "exotic",
...
static const char *substantiv[] = { "airplane", "album", "apple", "automobile",
	...
	"mango", "mesa", "mint", "monkey", "month", "moon", "motorcycle", "mountain",
	"ness", "nest",
	"oboe", "ocean", "octopus", "onion", "orange", "orchestra", "owl",
	"panda", "pant", "parade", "park", "path", "pear", "pencil", "penguin", "phrase", "phoenix", "piano", "pineapple", "planet", "plum", "pond", "poodle", "potato", "prairie",
	"quail",
	"rabbit", "raccoon", "raft", "raid", "rain", "raven", "reason", "review", "river", "road", "rock", "robert", "rosebud", "ruby",
	"sea", "seed", "shark", "sheep", "ship", "shoe", "shore", "shrub", "side", "silver", "sitter", "skates", "skin", "sky", "sled", "snail", "snake", "socks", "spark", "sparrow", "spider", "squash", "squirrel", "star", "state", "stream", "street", "studio", "sun",
	"table", "tablet", "teapot", "terrain", "theory", "tiger", "toast", "tomato", "town", "trail", "train", "tree", "truck", "trumpet", "tuba", "tulip", "turkey",
	"umbrella", "unicorn", "unit", "useful",
	"valley", "vase", "violet", "violin",
	"wagon", "water", "whale", "west", "wind", "window", "windy",
	"yard",
	"zebra", "zoo" };
