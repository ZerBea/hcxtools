...
static const char *adjectiv[] = { "absurd", "agency", "ago", "album", "ancient", "anchor", "antique", "aquatic",
	"baby", "bakery", "basic", "bay", "better", "big", "bitter", "black", "blue", "bold", "botany", "bottled", "brave", "breezy", "brief", "bright", "brown",
	"calm", "camera", "carrot", "cash", "charming", "cheerful", "chilly", "chip", "chorus", "chummy", "classy", "clean", "clear", "clever", "cloudy", "cold", "cool", "crispy", "curly",
	"daily", "deep", "delightful", "dizzy", "down", "dynamic",
	"east", "elated", "elegant", "energy", "engine", "excite", "excited", "exotic",
	"famous", "fancy", "fearless", "festive", "fluent", "fluffy", "formal", "free", "fresh", "friendly", "funny", "fuzzy",
	"gallon", "gentle", "gifted", "gigantic", "global", "good", "graceful", "grand", "great", "green",
	"happy", "harbor", "heavy", "height", "helpful", "hot", "hungry", "husky",
	"icy", "imaginary", "invent", "invisible",
	"jacket", "jagged", "jewel", "jolly", "joyful", "joyous",
	"kind", "kite", 
	"ladder", "large", "leader", "left", "lens", "light", "lime", "little", "lively", "locky", "lovely", "lucky", "lumpy",
	"magical", "major", "manic", "mellow", "melodic", "mighty", "misty", "modern", "month", 
	"narrow", "nest", "new", "nice", "nifty", "noisy", "normal",
	"oasis", "object", "occur", "ocean", "odd", "old", "orange", "ordinary",
	"painless", "parade", "pass", "pastel", "peaceful", "perfect", "phobic", "phone", "pink", "plain", "pledge", "polite",
	"poor", "precious", "pretty", "purple",
	"quaint", "quick", "quiet", "quote",
	"rain", "rapid", "red", "rocky", "rough", "round", "royal", "runner", "rustic",
	"safe", "safety", "salute", "sandy", "sharp", "shiny", "short", "silent", "silky", "silly", "slender", "slow",
	"slower", "small", "smart", "smiley", "smiling", "smooth", "snug", "soft", "sour", "stealth", "strange", "strong",
	"summit", "sunny", "super", "sweet", "swift", "swing",
	"tablet", "teal", "terrific", "thirsty", "thoughtful", "timber", "tiny",
...
static const char *substantiv[] = { "agency", "airplane", "album", "ape", "apple", "automobile",
	...
	"eagle", "earth", "elephant", "emerald", "epic",
	"farmer", "field", "finch", "fire", "fish", "flamingo", "flower", "fluent", "flute", "forest",
	"gadfly", "gate", "gear", "giant", "giraffe", "girl", "global", "glove", "grain", "grape", "grasshopper", "guppy",
	"hair", "hall", "hand", "hat", "hill", "hippo", "horse", "hotel", "house",
	"idea", "immune", "ink", "iris", "island",
	"jade", "jazz", "jeans", "jet", "jetcar", "jungle",
	"kangaroo", "kayak", "kite", "knight",
	"lake", "lawn", "lemon", "light", "lightning", "lion", "lotus", "lump",
	"mango", "mesa", "mint", "monkey", "month", "moon", "motorcycle", "mountain", "museum",
	"ness", "nest",
	"object", "oboe", "ocean", "octopus", "onion", "orange", "orchestra", "owl", "oxygen", 
	"panda", "pant", "parade", "park", "path", "patron", "pear", "pencil", "penguin", "phrase", "phoenix", "piano", "pineapple",
	"planet", "plum", "pocket", "poetry", "pond", "poodle", "potato", "prairie",
	"quail",
	"rabbit", "raccoon", "raft", "raid", "rain", "raven", "reason", "review", "reward", "river", "road", "rock", "robert", "rosebud",
	"ruby", "runner",
	"sea", "seed", "shark", "sheep", "ship", "shoe", "shore", "shrub", "side", "silver", "sitter", "skates", "skin", "sky", "sled",
	"snail", "snake", "soccer", "socks", "space", "spark", "sparrow", "spider", "squash", "squirrel", "stable", "star", "state", "stream", "street",
	"studio", "sun",
	...
	"wagon", "walnut", "water", "whale", "west", "wind", "window", "windy",
	"yard", "year",
	"zebra", "zoo" };
