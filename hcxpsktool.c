...
"royal", "runner", "rustic",
"safety", "salute", "scary", "scout", "sea", "sector", "seed", "shark",
"sheep", "shelf", "shiny", "ship", "shirt", "shoe", "short", "shrub",
"silent", "silky", "silly", "silver", "skates", "sky", "sled", "sleepy",
"slow", "small", "smart", "smiley", "smiling", "smooth", "snail", "snake",
"soccer", "socks", "space", "spark", "sparrow", "spider", "spirit", "spoon",
"square", "squash", "squirrel", "stable", "star", "state", "statue", "stealth",
"still", "stove", "straw", "street", "strong", "studio", "study", "summit",
"sun", "sunny", "super", "sweet", "swift",
