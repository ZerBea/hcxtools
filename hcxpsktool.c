...
"icy", "imaginary",
"jagged", "jolly", "joyous", "juicy",
"kind",
"large", "light", "little", "lively", "long", "loud", "lucky", "lunar",
...
{
"airplane", "apple",
"balloon", "banana", "bangle", "bay", "berry", "bike", "bird", "boat",
"bolt", "boot", "box", "brain", "bread", "breeze", "bug", "butter",
...
"panda", "phoenix", "piano", "pineapple", "planet", "plum", "police", "pond",
"poodle", "potato", "prairie",
"quail",
...
"daily", "damp", "decent", "deep", "degree", "desert", "dig", "direct",
"dizzy", "domain", "due", "dusty", "duty", "dynamic", "each", "eager",
"eagle", "east", "easy", "elated", "elegant", "empty", "energy", "engine",
"entire", "epic", "errand", "even", "every", "exact", "excited", "exotic",
"fair", "famous", "fancy", "farmer", "fast", "fearless", "festive", "few",
"finish", "first", "fit", "fluent", "fluffy", "formal", "free", "fresh",
"friend", "front", "full", "funny", "furry", "future", "fuzzy", "gallon",
...
"hotel", "hour", "hungry", "husky", "icy", "idea", "imaginary", "immune",
"input", "invent", "island", "jacket", "jagged", "jazz", "jeans", "jewel",
"jolly", "joyous", "judge", "juicy", "kettle", "key", "kind", "kite",
"knight", "known", "ladder", "large", "latter", "lazy", "leader", "left",
"legal", "less", "light", "like", "little", "lively", "long", "lost",
"lotus", "loud", "love", "loyal", "lucky", "magical", "major", "manic",
"many", "marble", "market", "master", "medium", "mellow", "melodic", "middle",
"mighty", "minute", "mirror", "misty", "mobile", "modern", "month", "most",
"much", "museum", "narrow", "nature", "nearby", "neat", "nest", "new",
"nifty", "night", "nine", "noble", "noisy", "normal", "north", "oasis",
"object", "ocean", "odd", "olive", "open", "orange", "outlet", "oxygen",
"palm", "parade", "past", "pastel", "patron", "perfect", "phobic", "phone",
"pin", "pink", "plain", "plane", "pledge", "plenty", "pocket", "polite",
"pony", "pool", "praise", "precious", "prior", "prize", "proper", "prose",
"proud", "purple", "quaint", "quick", "quiet", "quote", "rain", "rainy",
"rapid", "rare", "ready", "reason", "red", "remedy", "review", "reward",
"rich", "rocket", "rocky", "rough", "round", "royal", "runner", "rustic",
...
"some", "space", "spare", "square", "stable", "statue", "stealth", "stock",
"street", "strict", "strong", "studio", "such", "sudden", "summit", "sunny",
"super", "sweet", "swift", "tablet", "tall", "teal", "terrific", "that",
"theory", "thick", "think", "thirsty", "this", "tight", "timber", "tiny",
"top", "town", "train", "turtle", "uneven", "union", "unique", "unite",
"unusual", "upset", "urban", "useful", "usual", "valley", "vanilla", "vast",
"verse", "violet", "violin", "voyage", "wagon", "walnut", "warm", "watch",
"watery", "weekly", "west", "what", "wide", "windy", "wine", "winter",
...
"bridge", "bubble", "bug", "bunny", "bus", "butter", "cafe", "camera",
"canoe", "car", "carrot", "cartoon", "cello", "chair", "check", "cheek",
"cheese", "chorus", "city", "clerk", "clock", "coat", "coconut", "coffee",
"comet", "cookie", "cosmic", "country", "county", "course", "cow", "cream",
"crown", "curtain", "daisy", "data", "dealer", "deeper", "deer", "degree",
"desert", "desk", "diamond", "dinner", "dirt", "dog", "doll", "domain",
"drama", "drawer", "driver", "duty", "eagle", "ear", "earth", "editor",
"effort", "energy", "engine", "epic", "errand", "error", "estate", "event",
"extent", "famous", "farmer", "field", "fig", "finch", "finish", "fire",
"fish", "flower", "fluent", "flute", "form", "formal", "fox", "friend",
"gadfly", "gallon", "garden", "gate", "genius", "giant", "girl", "global",
"goal", "grain", "green", "guitar", "guppy", "hair", "hall", "hand",
"harbor", "hat", "height", "hill", "hippo", "hockey", "home", "honor",
"horse", "hotel", "house", "idea", "idol", "immune", "income", "ink",
"input", "invent", "iris", "island", "jacket", "jade", "jazz", "jeans",
"jet", "jewel", "judge", "jungle", "kayak", "kbus", "kettle", "key",
"kite", "knight", "ladder", "lake", "law", "lawn", "leader", "lemon",
"length", "light", "lion", "lotus", "loyal", "major", "mango", "map",
"marble", "market", "math", "meal", "memory", "menu", "mesa", "method",
"mint", "mirror", "mobile", "moment", "month", "moon", "mud", "museum",
...
"poem", "poet", "poetry", "policy", "pond", "poodle", "potato", "prairie",
...
"side", "singer", "skates", "sky", "sled", "snail", "snake", "snall",
"soccer", "socks", "sofa", "song", "space", "spark", "sparrow", "speech",
"spider", "spoon", "squash", "squirrel", "stable", "star", "state", "statue",
"storm", "stove", "straw", "street", "studio", "study", "summit", "sun",
"table", "tablet", "tea", "teapot", "teen", "tent", "thanks", "theory",
"tiger", "timber", "tomato", "tooth", "topic", "town", "trail", "train",
"tree", "truck", "trumpet", "truth", "tuba", "tulip", "turkey", "turtle",
"two", "unicorn", "union", "unit", "unite", "urban", "useful", "valley",
...
"any", "ape", "apt", "art", "ask",
"bad", "bay", "bee", "beg", "bet", "bid", "big", "bow", "box", "bud", "bun", "bus", "buy",
"cad", "cam", "can", "cob", "cog", "cop", "cud", "cup", "cut",
"dam", "did", "die", "dig", "dim", "dip", "dog", "dry", "dub", "due", "dug",
"ear", "ego", "elk", "end", "era", "eye",
"fab", "fan", "far", "fat", "fax", "fee", "few", "fin", "fit", "fix", "fly", "fog", "fox",
"fry",
"gap", "gel", "gem", "get", "god",
...
"jar", "job", "jog", "jot",
"key",
"lap", "law", "lay", "led", "leg", "let", "lid", "lie", "lip", "lit", "lob", "lop", "lot", "low",
"mad", "map", "max", "mid", "mix", "mob", "mop", "mow", "mud", "mug",
"nag", "nap", "net", "new", "nod", "nor", "not", "now",
"oar", "oat", "odd", "off", "oil", "old", "one", "opt", "our", "out", "owe", "own",
"pal", "pay", "pea", "peg", "pen", "per", "pet", "pie", "pin", "ply", "pop", "pub", "put",
"ran", "rat", "raw", "red", "rid", "rig", "rob", "rot", "rug", "run",
"sad", "sea", "set", "sew", "shy", "sim", "sin", "sip", "sir", "sit", "six", "sow", "soy", "spy",
...
"dame", "damp", "dare", "dash", "date", "days", "deaf", "deal", "desk", "dial", "dive", "door",
"duty", "dove", "down", "draw", "drop",
"each", "east", "edge", "edit", "epic", "even", "ever", "exit",
"face", "fair", "fake", "fall", "fame", "fast", "fine", "firm", "flag", "flee", "foam", "fold",
"foot", "four", "full", "fund", "fuse",
...
"look", "lord", "loss", "loud",
"menu", "mere", "mill", "mine", "mint", "mist", "mode", "moon", "most", "move", "much",
"name", "neat", "need", "nest", "noon", "nude",
"oars", "oust",
"pace", "pads", "page", "paid", "pain", "pale", "pane", "pars", "part", "pass", "past", "pear", "pegs",
"pens", "pier", "pine", "pins", "pint", "pity", "plan", "poem", "poet", "pond", "pool", "poor",
"post", "pure",
"rare", "real", "rest", "rich", "riot", "ripe", "road", "roam", "room", "root", "rude", "rule",
"safe", "sail", "sale", "same", "sand", "save", "scan", "seal", "seat", "seem", "send", "sent",
"shin", "shop", "shut", "sick", "side", "sift", "sign", "silk", "sing", "skip", "slim", "slip", "slum",
"soap", "soil", "sold", "solo", "sore", "sour", "spit", "step", "stew", "sure",
"tall", "teak", "team", "tear", "tent", "then", "tide", "time", "tone", "tour", "town", "trim", "trod",
"true", "tube", "tune", "turn",
"used",
"vain", "vast", "vend", "vote",
"wait", "walk", "want", "ward", "warn", "wave", "west", "wild", "wind", "wing", "wire", "wise", "worm"
};
...
"beams", "bland", "blank", "bleak", "boast", "boost", "bored", "bread", "bring", "broke",
...
"drunk", "dusts", "dusty",
"early", "elder", "enter", "equal", "equip", "erode", "evens", "event", "exact", "exams", "excel", "extra",
...
"judge",
"knock",
"laces", "large", "learn", "light", "lilac", "linen", "lofts", "loose", "lucky", "lunar", "lyric",
"madam", "major", "malts", "manor", "maple", "march", "marry", "merit", "moist", "molar", "motto", "mourn",
"mouse", "muddy",
"nacho", "novel", "nurse",
"offer", "optic",
"pages", "panda", "pants", "pause", "peace", "pedal", "pesto", "piece", "piety", "pings", "pious", "pivot", "place",
"plant", "pound", "prime", "prize", "probe", "prose", "proud", "prune", "puppy", "pylon",
"quiet",
...
"tally", "tempt", "tench", "tents", "these", "thick", "thief", "those", "tidal", "tiger", "title", "today",
"track", "train", "trick", "trust", "tuned", "twigs", "twist",
"unbid", "unbox", "uncap", "upend", "upper", "upset",
"valid", "vends", "verse", "vines", "visit",
