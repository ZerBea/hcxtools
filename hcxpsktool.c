...
"bold", "born", "botany", "brave", "breezy", "Breezy", "brew", "bridge",
"brief", "bright", "broad", "brown", "calm", "camera", "chance", "check",
"cheerful", "chilly", "choice", "chorus", "chummy", "classy", "clean", "clerk",
"clever", "close", "cloudy", "clumsy", "coffee", "cold", "common", "content",
"cool", "cosmic", "crispy", "curly", "daily", "damp", "decent", "deep",
"degree", "desert", "dig", "direct", "dizzy", "domain", "due", "dusty",
"duty", "dynamic", "each", "eager", "eagle", "easy", "elated", "elegant",
"empty", "energy", "engine", "entire", "epic", "errand", "even", "exact",
"excited", "exotic", "fair", "famous", "fancy", "farmer", "fast", "fearless",
"festive", "few", "finish", "first", "fit", "fluent", "fluffy", "formal",
"free", "fresh", "friend", "front", "funny", "furry", "future", "fuzzy",
"gallon", "genius", "gent|e", "gentle", "giddy", "gifted", "global", "gold",
"goofy", "grain", "grand", "great", "green", "grumpy", "guitar", "happy",
