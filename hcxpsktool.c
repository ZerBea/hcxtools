...
"icy", "idea", "ideal", "imaginary", "immune", "input", "invent", "island",
"jacket", "jagged", "jazz", "jeans", "jewel", "jolly", "joyous", "judge",
"juicy", "just", "kettle", "key", "kind", "kite", "knight", "known",
"ladder", "large", "last", "latter", "lazy", "leader", "least", "left",
"legal", "less", "light", "like", "little", "lively", "living", "long",
"lost", "lotus", "loud", "love", "loyal", "lucky", "magical", "major",
"manic", "many", "marble", "market", "master", "medium", "mellow", "melodic",
"middle", "mighty", "minute", "mirror", "misty", "mobile", "modern", "month",
"most", "much", "museum", "narrow", "nature", "nearby", "neat", "nest",
"new", "next", "nice", "nifty", "night", "nine", "noble", "noisy",
