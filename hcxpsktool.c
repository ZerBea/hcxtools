...
"dirt", "dog", "doll", "domain", "drama", "duty", "eagle", "ear",
"earth", "editor", "effort", "energy", "engine", "epic", "errand", "error",
"estate", "extent", "famous", "farmer", "field", "finch", "finish", "fire",
...
"loyal", "major", "mango", "marble", "market", "math", "menu", "mesa",
