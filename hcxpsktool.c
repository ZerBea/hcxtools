...
0xb345,
0xb350, 0xb351,
0xb360, 0xb366, 0xb367, 0xb36b, 0xb36e,
0xb372,
0xb393,
...
0xf871, 0xf877, 0xf879, 0xf87c,
0xf88a, 0xf88d,
0xf965,
0xfa24,
0xfa36,
0xfa41, 0xfa42, 0xfa43, 0xfa49, 0xfa4b,
0xfaa8, 0xfaac, 0xfaad,
...
static const char *firstword[] = { "absurd", "agency", "ago", "album", "ancient", "anchor", "antique", "aquatic",
	...
	"eager", "east", "elated", "elegant", "emigrant", "energy", "engine", "excite", "excited", "exotic",
	"famous", "fancy", "fast", "fearless", "festive", "few", "finish", "fluent", "fluffy", "formal", "free", "fresh", "friendly", "funny", "fuzzy",
...
static const char *secondword[] = { "absent", "acre", "agency", "airplane", "album", "ape", "apple", "automobile",
	...
	"canoe", "car", "cat", "carrot", "cartoon", "cello", "chair", "chat", "cheese", "chill", "chip", "coast", "coconut", "comet",
	...
	"plane", "planet", "pledge", "plum", "pocket", "poetry", "pond", "poodle", "potato", "prairie", "prose",
