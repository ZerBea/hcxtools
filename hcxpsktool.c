...
"kettle", "kind", "kite",
"ladder", "large", "left", "light", "little", "lively", "loyal", "lucky", "loud",
...
"salute", "shiny", "shelf", "short", "silent", "silky", "silly", "slow", "small", "smart", "smiley", "smiling", "smooth", "spirit",
"stealth", "still", "strong", "summit", "sunny", "super", "sweet", "swift",
"tablet", "tall", "teal", "terrific", "thirsty", "timber", "tiny", "town",
