...
if(pmkidwrittenhcount > 0)		printf("PMKID written (hashcat)........: %ld\n", pmkidwrittenhcount);
if(pmkidwrittenjcount > 0)		printf("PMKID written (JtR)............: %ld\n", pmkidwrittenjcount);
...
if(eapolcount > 0)			printf("EAPOL message pairs............: %ld\n", eapolcount);
if(eapolwrittenhcount > 0)		printf("EAPOL message written (hashcat): %ld\n", eapolwrittenhcount);
return;
}
/*===========================================================================*/
...
/*===========================================================================*/
static void addhandshake(uint64_t eaptimegap, uint64_t rcgap, messagelist_t *msgclient, messagelist_t *msgap)
{
...
for(zeiger = messagelist; zeiger < messagelist +MESSAGELIST_MAX; zeiger++)
	...
	if(zeiger->message == HS_M3)
		...
		if(eaptimegap <= eapoltimeoutvalue) addhandshake(eaptimegap, rcgap, messagelist +MESSAGELIST_MAX, zeiger);
		}
