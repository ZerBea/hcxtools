...
if(eapolm1authlen > 0) fprintf(stdout, "EAPOL M1 authentication length (max).....: %" PRIu16 "\n", eapolm1authlen);
...
if(eapolm2authlen > 0) fprintf(stdout, "EAPOL M2 authentication length (max).....: %" PRIu16 "\n", eapolm2authlen);
...
if(eapolm3authlen > 0) fprintf(stdout, "EAPOL M3 authentication length (max).....: %" PRIu16 "\n", eapolm3authlen);
...
if(eapolm4authlen > 0) fprintf(stdout, "EAPOL M4 authentication length (max).....: %" PRIu16 "\n", eapolm4authlen);
