...
#define HCX_LOG_OUT				10
#define HCX_PMKID_OUT_DEPRECATED		11
#define HCX_HCCAPX_OUT_DEPRECATED		12
#define HCX_HCCAP_OUT_DEPRECATED		13
#define HCX_PMKIDEAPOLJTR_OUT_DEPRECATED	14
#define HCX_PREFIX_OUT				15
