...
#define HCX_INFO_VENDOR_OUT		31
#define HCX_INFO_VENDOR_AP_OUT		32
#define HCX_INFO_VENDOR_CLIENT_OUT	33
#define HCX_HCCAPX_OUT			34
#define HCX_HCCAP_OUT			35
#define HCX_HCCAP_SINGLE_OUT		36
#define HCX_JOHN_OUT			37
