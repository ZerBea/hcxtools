...
#define HCX_MAC_GROUP		6
#define HCX_OUI_GROUP		7
#define HCX_FILTER_OUI_AP	8
#define HCX_FILTER_OUI_CLIENT	9
#define HCX_FILTER_MAC_AP	10
#define HCX_FILTER_MAC_CLIENT	11
#define HCX_FILTER_VENDOR	12
#define HCX_FILTER_ESSID	13
#define HCX_FILTER_ESSID_PART	14
#define HCX_FILTER_RC		15
#define HCX_FILTER_M12		16
#define HCX_FILTER_M1234	17
#define HCX_FILTER_APLESS	18
#define HCX_PSK			19
#define HCX_PMK			20
#define HCX_VENDOR_OUT		21
#define HCX_INFO_OUT		22
#define HCX_HCCAPX_OUT		23
#define HCX_HCCAP_OUT		24
#define HCX_JOHN_OUT		25
